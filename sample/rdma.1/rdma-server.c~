...
static void* passive_init(void * arg /*(struct RDMA_communicator *comm)*/)  
{
  ...
  while (1) {
    ...
    case RDMA_CM_EVENT_CONNECT_REQUEST:
      ...
      //      struct ibv_qp_init_attr *qp_attr1 = &qp_attr;
      //      
      //      memset(qp_attr1, 0, sizeof(*qp_attr1));
      //      
      //      qp_attr1->send_cq = s_ctx->cq;
      //      qp_attr1->recv_cq = s_ctx->cq;
      //      qp_attr1->qp_type = IBV_QPT_RC;
      //      
      //      qp_attr1->cap.max_send_wr = 10;
      //      qp_attr1->cap.max_recv_wr = 10;
      //      qp_attr1->cap.max_send_sge = 1;
      //      qp_attr1->cap.max_recv_sge = 1;
      //      /**/
      ...
      //      struct rdma_conn_param *params = &conn_param;
  ...
  while (1) {
	...
	switch (conn->recv_msg->type)
	  ...
	  case MR_INIT:
	    ...
	    rdma_buff = (struct RDMA_buff *) malloc(sizeof(struct RDMA_buff));
	    rdma_buff->buff = (char *)malloc(conn->recv_msg->data1.buff_size);
